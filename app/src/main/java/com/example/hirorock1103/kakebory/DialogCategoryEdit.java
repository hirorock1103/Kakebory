...
public class DialogCategoryEdit extends AppCompatDialogFragment {
    ...
    private DialogCategory.ActivityNoticeListner listner;
    ...
    public void onAttach(Context context) {
        ...
        try{
            listner = (DialogCategory.ActivityNoticeListner)context;
